...
## Version 1.4.6 (Version Update)

### 🆕 Atualizações

- **Versão atualizada**: Projeto atualizado para versão 1.4.6
...
## Version 1.4.5 (Version Update)

### 🆕 Atualizações

- **Versão atualizada**: Projeto atualizado para versão 1.4.5
- **Data de atualização**: 2025-07-22
- **Gerenciamento centralizado**: Versões agora gerenciadas via scripts/version-manager.sh
