...
setup_kiosk_fullscreen() {
    ...
    if should_skip_step "$step" "$last_step"; then
        log_info "⏭️  Pulando configuração do kiosk fullscreen (já executada)"
        return 0
    fi
    ...
    log_info "Configurando script de inicialização fullscreen..."
...
# =============================================================================
# FUNÇÃO PARA EXIBIR VARIÁVEIS KIOSK
# =============================================================================
...
ssh_start() {
    ...
    echo "ℹ️  Comando: sudo systemctl start kiosk-fullscreen.service"
...
EOF
    ...
    log_info "Criando serviço systemd para kiosk fullscreen..."
...
SERVICE_EOF
    ...
    log_success "✅ Kiosk fullscreen configurado com sucesso"
    log_info "📋 Para iniciar: sudo systemctl start kiosk-fullscreen.service"
    log_info "📋 Para parar: sudo systemctl stop kiosk-fullscreen.service"
}
